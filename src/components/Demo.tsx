...
import { ConfettiEventTimeline } from "./organisms/EventTimeline/ConfettiEventTimeline";
...
// Helper function to create dates for today
function createEventDate(hours: number, minutes: number = 0): Date {
...
const sampleTimelineEvents: TimelineEvent[] = [
        {
                ...
                description:
                        "Hang balloons, streamers, and set up photo booth area",
                start: createEventDate(14, 0),
                end: createEventDate(15, 30),
                type: "duration",
                color: "bg-amber-200",
                ...
                tasks: [
                        { id: "t1", title: "Hang balloons", status: "todo" },
                        {
                                id: "t2",
                                title: "Set up photo booth",
                                status: "doing",
                        },
                        { id: "t3", title: "Test lighting", status: "todo" },
                ],
        ...
        },
        {
                ...
                start: createEventDate(16, 0),
                end: createEventDate(16, 30),
                type: "duration",
                ...
                tasks: [
                        { id: "t4", title: "Welcome guests", status: "todo" },
                        { id: "t5", title: "Check guest list", status: "todo" },
                ],
        },
        {
                id: "3",
                ...
                start: createEventDate(17, 30),
                end: createEventDate(18, 0),
                type: "duration",
                color: "bg-pink-200",
                location: "Main Party Room",
                attendees: 25,
        ...
        },
        {
                ...
                assignedTo: ["DJ"],
                tasks: [
                        { id: "t6", title: "Test microphones", status: "todo" },
                        { id: "t7", title: "Check speakers", status: "todo" },
                ],
        },
        {
                id: "5",
...
export const Demo: React.FC = () => {
        const [showProgressTracker, setShowProgressTracker] =
                React.useState(false);
        const [timelineEvents, setTimelineEvents] =
                React.useState<PartyEvent[]>(samplePartyEvents);
        const [progressCategories, setProgressCategories] = React.useState<
                ProgressCategory[]
        >([
                {
                        id: "theme-analysis",
                        ...
                        steps: [
                                {
                                        ...
                                        description:
                                                "Processing your party style and theme preferences",
                                        status: "pending",
                                        progress: 0,
                                ...
                                },
                                {
                                        ...
                                        description:
                                                "Tailoring the theme to match your vision",
                                        status: "pending",
                                        progress: 0,
                        ...
                        steps: [
                                {
                                        ...
                                        description:
                                                "Creating personalized party elements and decorations",
                                        status: "pending",
                                        progress: 0,
                                        estimatedTime: "2 min",
                                },
                                {
                                        ...
                                        description:
                                                "Generating custom images for your party theme",
                                        status: "pending",
                                        progress: 0,
                                        estimatedTime: "1 min",
                                },
        ...
        const partyOptions: PartyOption[] = [
                {
                        ...
                        description:
                                "Celebrate another year of life with cake, balloons, and unforgettable memories",
                        icon: "cake",
                        features: [
                ...
                },
                {
                        ...
                        title: "Baby Shower",
                        description:
                                "Welcome the new arrival with sweet celebrations and precious moments",
                        icon: "baby",
                        features: [
                ...
                },
                {
                        ...
                        title: "Dinner Party",
                        description:
                                "Host an elegant evening with fine dining and sophisticated ambiance",
                        icon: "dinner",
                        features: [
        ...
        return (
                <div className="min-h-screen bg-background p-8">
                        <div className="max-w-6xl mx-auto space-y-12">
                                ...
                                <section className="space-y-8">
                                        <h2 className="text-3xl font-semibold text-foreground">
                                                Event Timeline (New Structure)
                                        </h2>
                                        <ConfettiEventTimeline
